<%@page contentType="text/html;" pageEncoding="UTF-8" import="com.cardona.apiservlet.webapp.models.*"%>
...
<form name="formcarro" action="<%=request.getContextPath()%>/actualizar-carro" method="post">
    <table>
        ...
        <tr>
            ...
            <td><label>
                <input type="text" size="4" name="cant_<%=item.getProducto().getId()%>" value="<%=item.getCantidad()%>" />
            </label></td>
